...
A cuick code to create a useful plot to visualise pre- and post-test results.
...
xbox <- axis_canvas(pmain, axis = "x", coord_flip = TRUE) + 
  geom_boxplot(data = df_wide, aes(y = Pretest, x = Groups), outlier.size = 1) + 
...
ybox <- axis_canvas(pmain, axis = "y") + 
  geom_boxplot(data = df_wide, aes(y = Posttest, x = Groups), outlier.size = 1) +
